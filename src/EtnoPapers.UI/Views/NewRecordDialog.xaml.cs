    ...
    public partial class NewRecordDialog : Window
    {
        ...
        private void CreateButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            CreatedRecord = new ArticleRecord
            {
                ...
                Ano = ano,
                Pais = string.IsNullOrWhiteSpace(PaisTextBox.Text) ? "" : PaisTextBox.Text,
                Estado = string.IsNullOrWhiteSpace(EstadoTextBox.Text) ? "" : EstadoTextBox.Text,
                Municipio = string.IsNullOrWhiteSpace(MunicipioTextBox.Text) ? "" : MunicipioTextBox.Text,
                Bioma = string.IsNullOrWhiteSpace(BiomaTextBox.Text) ? "" : BiomaTextBox.Text,
