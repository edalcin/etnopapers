...
public static class CloudErrorMapper
{
    ...
    {
        HttpStatusCode.Unauthorized => "Chave de API inválida ou expirada. Verifique suas configurações.",
        HttpStatusCode.Forbidden => "Acesso negado ao provedor de IA. Verifique sua chave de API e permissões.",
        HttpStatusCode.NotFound => "O modelo ou endpoint do provedor não foi encontrado.",
        HttpStatusCode.TooManyRequests => "Limite de requisições excedido. Aguarde um momento e tente novamente.",
        HttpStatusCode.BadRequest => "Requisição inválida. Os dados do PDF podem estar corrompidos.",
        ...
        _ => $"Erro da API: {statusCode:D} {statusCode:G}. Tente novamente mais tarde."
    };
